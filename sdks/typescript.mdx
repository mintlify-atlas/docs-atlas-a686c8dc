...
<CardGroup cols={2}>
  <Card title="Next.js SDK" icon="react" href="/guides/nextjs">
    Framework wrapper for Next.js
  </Card>
  <Card title="Hono SDK" icon="flame" href="/guides/hono">
    Middleware for Hono apps
  </Card>
  <Card title="Rate Limiting Guide" icon="gauge-high" href="/features/rate-limiting">
